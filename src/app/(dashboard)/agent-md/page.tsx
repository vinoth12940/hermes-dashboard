    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="glass-card p-6">
        <textarea
          ...
          className="w-full h-[70vh] bg-zinc-900/80 text-zinc-300 font-mono text-sm p-4 rounded-xl border border-zinc-800/50 resize-none focus:border-indigo-500/50 leading-relaxed"
          spellCheck={false}
